...
import { getDevice } from '@/domain/snapshot/node';
import { screenshotStorage } from '@/domain/snapshot/storage';
...
const { snapshotImportTime, snapshotViewedTime } = useStorageStore();
