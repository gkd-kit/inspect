...
const selectorSyntaxInputSource = readFileSync(
  new URL('../../components/base/SelectorSyntaxInput.vue', import.meta.url),
  'utf8',
);
const selectorTextSource = readFileSync(
  new URL('../../components/selector/SelectorText.vue', import.meta.url),
  'utf8',
);
const selectorLibraryPageSource = readFileSync(
  new URL('../selector/SelectorLibraryPage.vue', import.meta.url),
  'utf8',
);
const selectorLibraryDialogSource = readFileSync(
  new URL(
    '../../components/selector/SelectorLibraryDialog.vue',
    import.meta.url,
  ),
  'utf8',
);
const deviceActionDialogsSource = readFileSync(
  new URL('../device/DeviceActionDialogs.vue', import.meta.url),
  'utf8',
);
