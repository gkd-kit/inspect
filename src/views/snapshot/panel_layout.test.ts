...
} from '../../components/base/draggable.ts';

const readSource = (path: string) =>
  readFileSync(new URL(path, import.meta.url), 'utf8');
const draggableCardSource = readSource(
  '../../components/base/DraggableCard.vue',
);
const snapshotPageSource = readSource('./SnapshotPage.vue');
const panelSources = [
  './SearchCard.vue',
  './RuleCard.vue',
  './AttrCard.vue',
