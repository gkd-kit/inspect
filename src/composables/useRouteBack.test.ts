...
const pageSources = [
  '../views/device/DevicePage.vue',
  '../views/selector/SelectorPage.vue',
  '../views/selector/SelectorLibraryPage.vue',
  '../views/snapshot/SnapshotPage.vue',
  '../views/log/LogToolbar.vue',
].map(readSource);
