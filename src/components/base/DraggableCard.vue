...
import {
  ...
  useDragMove,
  useZindex,
  type DraggableCardValue,
} from './draggable';

const props = withDefaults(
  defineProps<{
    initialValue?: DraggableCardValue;
    minWidth?: number;
...
const emit = defineEmits<{
  'update:value': [value: DraggableCardValue];
}>();
...
const getCurrentValue = (): DraggableCardValue => {
  const value: DraggableCardValue = {};
