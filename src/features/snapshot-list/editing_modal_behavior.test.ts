...
const homePageSource = readSource('./SnapshotListView.vue');
const settingsModalSource = readSource(
  '../../features/settings/SettingsModal.vue',
);
const deviceDialogsSource = readSource(
  '../../features/device-control/DeviceActionDialogs.vue',
);
const privacyDialogSource = readSource(
  '../../features/snapshot-inspector/PrivacyRedactionDialog.vue',
);
const screenshotCardSource = readSource(
  '../../features/snapshot-inspector/ScreenshotCard.vue',
);
